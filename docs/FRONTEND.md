# ProtEngine Labs Frontend — ProtEngine Labs

> A modern, professional Next.js + React interface for real-time drug discovery pipeline visualization and results analysis.

## 🎯 Overview

This frontend provides a complete user interface for ProtEngine Labs v4, a 22-agent AI system that transforms protein mutations into ranked drug candidates with synthesis routes and clinical context.
...
NEXT_PUBLIC_APP_NAME=ProtEngine Labs
...
Part of ProtEngine Labs v4 (Hackfest 2026)
